  ...
  <div class="row">
    ...
    <div class="col-md-4 mb-4">
      <div class="card h-100">
        <img src="<?php echo e(asset('images/'.$barang->gambar)); ?>" class="card-img-top" alt="<?php echo e($barang->nama_barang); ?>">
        <div class="card-body d-flex flex-column">
          <h5 class="card-title"><?php echo e($barang->nama_barang); ?></h5>
          <p class="card-text text-success fw-bold mb-1">Rp <?php echo e(number_format($barang->harga)); ?>/<?php echo e($barang->satuan); ?></p>
          
          <!-- Stok Notice -->
          <?php if($barang->stok > 0): ?>
            <p class="card-text"><span class="badge bg-info text-dark">Stok: <?php echo e($barang->stok); ?></span></p>
          <?php else: ?>
          ...
          <div class="mt-auto">
            <!-- Update stok -->
            <form method="POST" action="<?php echo e(route('admin.updateStok', $barang->id_barang)); ?>" class="d-flex align-items-center mb-2">
              <?php echo csrf_field(); ?>
              <div class="input-group input-group-sm" style="width: 120px;">
                <button type="button" class="btn btn-outline-secondary btn-minus">−</button>
                <input type="number" name="stok" class="form-control text-center" min="1" value="<?php echo e($barang->stok); ?>">
            ...
            <!-- Hapus produk -->
            <form method="POST" action="<?php echo e(route('admin.hapusProduk', $barang->id_barang)); ?>">
              <?php echo csrf_field(); ?>
...
<div class="modal fade" id="modalTambahProduk" tabindex="-1">
  <div class="modal-dialog">
    <form method="POST" action="<?php echo e(route('admin.simpanProduk')); ?>" enctype="multipart/form-data" class="modal-content">
      <?php echo csrf_field(); ?>
...
<?php /**PATH D:\laragon\www\laravel11\resources\views/admin.blade.php ENDPATH**/ ?>