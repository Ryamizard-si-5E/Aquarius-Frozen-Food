  ...
  <div class="row g-4">
    ...
    <div class="col-md-3">
      ...
      <div class="card product-card h-100 shadow-sm" 
           ...
           data-bs-target="#popup-{{ $barang->id_barang }}">
        ...
        <div class="card-body text-center">
          ...
          {{-- Jika stok habis tampilkan teks --}}
          @if($barang->stok == 0)
...
<div class="modal fade" id="popup-{{ $barang->id_barang }}" tabindex="-1">
          ...
          <div class="col-md-6">
            ...
            @if($barang->stok > 0)
              <div class="mb-3">
                ...
                <input type="number" class="form-control" min="1" max="{{ $barang->stok }}" value="1" disabled>
              </div>
              <a href="#"
  ...
  <div class="text-center mt-5">
    <a href="{{ route('index') }}" class="btn btn-lg btn-gradient">
      Lihat Semua Produk →
    </a>
  </div>
</div>
