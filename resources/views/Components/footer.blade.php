    ...
    <div class="row">
      ...
      <div class="col-md-4 mb-4">
        ...
        <ul class="list-unstyled">
          <li><a href="{{ route('dashboard') }}" class="text-light text-decoration-none">Beranda</a></li>
          <li><a href="{{ route('login') }}" onclick="alert('Silakan login terlebih dahulu untuk Masuk ke keranjang');">
    Keranjang
    </a></li>
          <li><a href="{{ route('index') }}" class="text-light text-decoration-none">Keluar</a><li>
        </ul>
      </div>
